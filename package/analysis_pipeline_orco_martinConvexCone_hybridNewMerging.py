...
import os
import subprocess
def analysis_pipeline_orco_martinConvexCone_hybridNewMerging(option_ds):
    ...
    folder_code_matlab = f'{folder_code}/matlab/part6'
    script_template = os.path.join(folder_code, 'ZZ_runConvexCone_scotty_template.m')

    # save the script of this experiment to 
    script_save = os.path.join(folder_martin, 'ZZ_Scripts', f'{experiment_name}_runConvexCone.m')
...
def main():
    ...
    analysis_pipeline_orco_martinConvexCone_hybridNewMerging(option_ds)
