...
experiment_name = 'checkSensitivityPhase2CMTK_manual';
brains = {'checkSensitivityPhase2F1' ,'checkSensitivityPhase2F2' ,'checkSensitivityPhase2F4' ,'checkSensitivityPhase2F5'};
datasets = {'20191218_checkSensitivityPhase2' ,'20191220_checkSensitivityPhase2' ,'20191225_checkSensitivityPhase2' ,'20191228_checkSensitivityPhase2'};
meta_file = 'checkSensitivityPhase2CMTK_manual_meta_data.mat';
...
cd('/mnt/cup/labs/mcbride/lukas/CalciumImaging/FCV/Analysis/MartinStrauch_hybridNewMerging/glomerulus_matching_scotty');
addpath(genpath('/mnt/bucket/labs/mcbride/zhileizhao/Scotty/Analysis/CalciumImaging/AnalysisPipelineOrco/MartinStrauch/glomerulus_matching_scotty'));
...
regime1_intervals.reference = [30:80];  %baseline before odor stimulation
regime1_intervals.signal =  [100:125];   %time points at which the odor response is extracted
