...
regime1 = 1:62;                         %in the example, the first 28 odors are single odorants
...
%constraints.functional_threshold = 0.1; %Functional distances (odor response correlations) < functional_threshold will be penalized
...
% clustering_threshold = 0.008; % the higher, the more glomeruli will be merged
% for(i=1:length(F_cc))
...
%new merging function: 10/11/2020
...
correlation_threshold = 0.75; overlap_threshold=0.1;
for(i=1:length(F_cc))
